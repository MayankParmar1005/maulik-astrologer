...
export interface backendInterface {
     ...
     * / Add a new blog post
     */
    addBlogPost(title: string, excerpt: string, content: string, tags: Array<string>, published: boolean): Promise<bigint>;
    /**
     * / Add a new message
     */
    addMessage(name: string, email: string, subject: string, message: string): Promise<bigint>;
    /**
     * / Add a new project
     */
    addProject(title: string, description: string, techStack: Array<string>, liveUrl: string, repoUrl: string): Promise<bigint>;
    /**
...
export class Backend implements backendInterface {
    ...
    async addBlogPost(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: boolean): Promise<bigint> {
    ...
    async addMessage(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addMessage(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addProject(arg0: string, arg1: string, arg2: Array<string>, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
